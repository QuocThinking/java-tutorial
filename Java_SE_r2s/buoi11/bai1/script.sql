...
create table nhanvien(
	MaNV  varchar(9) primary key default '',
...
create table chungnhan(
	MaNV varchar(9) not null default '' foreign key references nhanvien(MaNV),
	MaMB int default 0 foreign key references maybay(MaMB),
